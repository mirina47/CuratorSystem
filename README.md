...
3. В phpMyAdmin создайте базу данных с названием curator_system и кодировкой utf8_general_ci.
4. Импортируйте базу данных из файла curator_system.sql (по желанию).
    * Примечание:
